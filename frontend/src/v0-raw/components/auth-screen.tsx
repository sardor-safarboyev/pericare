...
const roles = Object.keys(ROLE_LABELS) as ClinicalRole[]
const facilities = Object.keys(FACILITY_LABELS) as FacilityType[]
...
export function AuthScreen() {
  ...
  const [role, setRole] = useState<ClinicalRole>("midwife")
  const [facility, setFacility] = useState<FacilityType>("district_maternity")
